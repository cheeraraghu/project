            ...
            <section>
              ...
              {upcomingBookings.length > 0 ? (
                ...
                <div className="bg-white rounded-lg shadow-sm p-12 text-center">
                  ...
                  <button className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white px-6 py-2 rounded-lg hover:from-blue-600 hover:to-pink-600">
                    Browse Movies
                  </button>
                </div>
              )}
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className="flex items-center space-x-2 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white px-4 py-2 rounded-lg hover:from-blue-600 hover:to-pink-600 transition-colors"
              >
