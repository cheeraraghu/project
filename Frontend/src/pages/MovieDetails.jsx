              ...
              <div className="text-white flex-1">
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    ...
                    className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-600 hover:to-pink-600 text-white px-8 py-3 rounded-lg font-semibold transition-colors flex items-center space-x-2"
                  >
                  ...
                  <button
                    ...
                    className={`p-3 rounded-lg transition-colors ${
                      isLiked ? 'bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white' : 'bg-gray-800 text-white hover:bg-gray-700'
                    }`}
                  >
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white px-6 py-2 rounded-lg hover:from-blue-600 hover:to-pink-600 transition-colors"
                    >
                      Submit Review
                    </button>
                  </div>
