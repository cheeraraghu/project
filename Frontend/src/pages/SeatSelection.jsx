                    ...
                    <button
                      ...
                      className={`w-8 h-8 rounded-lg border-2 text-xs font-semibold transition-all ${
                        isOccupied
                          ...
                          : isSelected
                          ? 'bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 border-none text-white'
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 mb-8 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="flex items-center space-x-2">
                  <div className="w-4 h-4 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded border-none"></div>
              ...
              {selectedSeats.length > 0 ? (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-pink-600 transition-colors disabled:opacity-50"
                  >
