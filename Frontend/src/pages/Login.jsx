      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <Link to="/" className="inline-block">
            <div className="bg-gradient-to-r from-red-600 to-red-700 text-white px-6 py-3 rounded-lg font-bold text-2xl">
              IMovieShow
            </div>
          </Link>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <a
                ...
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-150"
              >
                <div className="relative">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="h-8 w-8 rounded-full bg-transparent border-2 border-red-500 flex items-center justify-center text-red-500 font-bold">
                      G
                    </div>
                  </div>
              ...
              >
                <div className="relative">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="h-8 w-8 rounded-full bg-transparent border-2 border-blue-500 flex items-center justify-center text-blue-500 font-bold">
                      F
                    </div>
                  </div>
                  <span className="ml-10"></span>
