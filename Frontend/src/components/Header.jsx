...
const Header = ({ user, onLogout, selectedLocation, setSelectedLocation }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 shadow-lg z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-2">
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-xl font-bold text-2xl shadow-md transition-all duration-300">
              IMovie
            </div>
          </Link>
          ...
          <div className="hidden md:flex flex-1 max-w-2xl mx-8 relative">
            <form onSubmit={handleSearch} className="w-full relative">
              <input
                ...
                className="w-full pl-10 pr-12 py-3 border border-blue-300 rounded-full focus:ring-2 focus:ring-purple-500 focus:border-transparent shadow-md hover:shadow-lg transition-all duration-300 bg-blue-50 focus:bg-white"
              />
              <Search className="absolute left-3 top-2.5 h-5 w-5 text-blue-400" />
              <button
                type="submit"
                className="absolute right-2 top-1.5 bg-gradient-to-r from-blue-500 to-purple-600 text-white p-2 rounded-full shadow-lg hover:scale-105 hover:shadow-xl transition-all duration-300"
              >
